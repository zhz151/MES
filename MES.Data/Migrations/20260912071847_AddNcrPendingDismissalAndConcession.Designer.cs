...
namespace MES.Data.Migrations
{
    ...
    [Migration("20260912071847_AddNcrPendingDismissalAndConcession")]
    partial class AddNcrPendingDismissalAndConcession
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("MES.Data.Entities.Batch.OutsourceVendorProfile", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.HasIndex("VendorCode")
                        .IsUnique()
                        .HasDatabaseName("UK_OutsourceVendor_Code");

                    b.HasIndex("VendorName", "SectionName")
                        .IsUnique()
                        .HasDatabaseName("UK_OutsourceVendor_Name_Section");

                    b.ToTable("OutsourceVendorProfile", (string)null);
                });
            ...
            modelBuilder.Entity("MES.Data.Entities.Batch.ProcessGroup", b =>
                {
                    ...
                    b.Property<int?>("BrightAnnealing")
                        .HasColumnType("int");

                    b.Property<int?>("ClothPolish")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("MES.Data.Entities.Configuration.CertificatePrintColumnDefinition", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.ToTable("CertificatePrintColumnDefinitions", (string)null);
                });

            modelBuilder.Entity("MES.Data.Entities.Configuration.CertificatePrintSetting", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("MES.Data.Entities.Configuration.DictValueDefinition", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.HasIndex("DictKey", "Value")
                        .IsUnique()
                        .HasDatabaseName("UK_DVD_DictKey_Value");

                    b.ToTable("DictValueDefinitions", (string)null);
                });
            ...
            modelBuilder.Entity("MES.Data.Entities.Configuration.Employee", b =>
                {
                    ...
                    b.Property<bool?>("MaterialReceiveCheckItems")
                        .HasColumnType("bit");
            ...
            modelBuilder.Entity("MES.Data.Entities.Configuration.EnumDisplayDefinition", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("MES.Data.Entities.Configuration.ProcessDefinition", b =>
                {
                    ...
                    b.Property<bool>("IsColdDraw")
                        .HasColumnType("bit");

                    b.Property<bool>("IsColdRoll")
                        .HasColumnType("bit");
            ...
            modelBuilder.Entity("MES.Data.Entities.Order.OrderListSummary", b =>
                {
                    ...
                    b.Property<bool>("BusinessCompleted")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bit")
                        .HasDefaultValue(false);
                    ...
                    b.Property<decimal>("FinishedInboundWeight")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("decimal(18,2)")
                        .HasDefaultValue(0m);

                    b.Property<decimal>("FinishedOutboundWeight")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("decimal(18,2)")
                        .HasDefaultValue(0m);

                    b.Property<decimal>("FinishedStockWeight")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("decimal(18,2)")
                        .HasDefaultValue(0m);
            ...
            modelBuilder.Entity("MES.Data.Entities.Payroll.AttendanceRecord", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.HasIndex("EmployeeId", "AttendDate")
                        .IsUnique()
            ...
            modelBuilder.Entity("MES.Data.Entities.Payroll.PieceRateFinalInspectionCategory", b =>
                {
                    ...
                    b.ToTable("PieceRateFinalInspectionCategories", (string)null);
                });

            modelBuilder.Entity("MES.Data.Entities.Payroll.PieceRateFinalInspectionCategoryTier", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.HasIndex("CategoryId")
                        .HasDatabaseName("IX_FinalInspectionTier_Category");

                    b.ToTable("PieceRateFinalInspectionCategoryTiers", (string)null);
                });

            modelBuilder.Entity("MES.Data.Entities.Payroll.PieceRateProductionCategory", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.HasIndex("SectionKey", "IsActive")
                        .HasDatabaseName("IX_Category_Section_Active");

                    b.ToTable("PieceRateProductionCategories", (string)null);
                });

            modelBuilder.Entity("MES.Data.Entities.Payroll.PieceRateProductionCategoryKey", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.HasIndex("CategoryId", "ConstraintType", "Key")
                        .IsUnique()
                        .HasDatabaseName("UK_CategoryKey_Type_Key");

                    b.ToTable("PieceRateProductionCategoryKeys", (string)null);
                });

            modelBuilder.Entity("MES.Data.Entities.Payroll.PieceRateProductionCategoryTier", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("MES.Data.Entities.Quality.NcrPendingDismissal", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<int>("DismissedQuantity")
                        .HasColumnType("int");
                    ...
                    b.HasIndex("SourceType", "ProductionBatchId", "InspectionType", "InspectionItem", "ProcessName")
                        .IsUnique()
                        .HasDatabaseName("UK_NcrPendingDismissal_Group");

                    b.ToTable("NcrPendingDismissal", (string)null);
                });
            ...
            modelBuilder.Entity("MES.Data.Entities.Warehouse.InventoryBatch", b =>
                {
                    ...
                    b.HasIndex("ProductionMainNo")
                        .HasDatabaseName("IX_InventoryBatch_ProductionMainNo");
            ...
            modelBuilder.Entity("MES.Data.Entities.Warehouse.OutboundRecord", b =>
                {
                    ...
                    b.Property<string>("ReturnSourceBatchNo")
                        .HasMaxLength(100)
                        .HasColumnType("nvarchar(100)");
            ...
            modelBuilder.Entity("MES.Data.Entities.Payroll.PieceRateFinalInspectionCategoryTier", b =>
                {
                    b.HasOne("MES.Data.Entities.Payroll.PieceRateFinalInspectionCategory", "Category")
                        .WithMany("Tiers")
            ...
            modelBuilder.Entity("MES.Data.Entities.Payroll.PieceRateProductionCategoryKey", b =>
                {
                    b.HasOne("MES.Data.Entities.Payroll.PieceRateProductionCategory", "Category")
                        .WithMany("ConstraintKeys")
                        .HasForeignKey("CategoryId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
