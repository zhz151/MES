...
{
    /// <inheritdoc />
    public partial class AddStandardInspectionRequirement : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                name: "StandardInspectionRequirement",
                columns: table => new
                {
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_StandardInspectionRequirement", x => x.Id);
                });

            migrationBuilder.CreateIndex(
                name: "UK_StandardInspectionRequirement_StandardNo",
                table: "StandardInspectionRequirement",
                column: "StandardNo",
                unique: true);
        }
