...
namespace MES.Data.Migrations
{
    ...
    [Migration("20260802184322_QualityProcessTrackingAddManufacturingStatusAndEndCustomer")]
    partial class QualityProcessTrackingAddManufacturingStatusAndEndCustomer
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("MES.Data.Entities.Quality.QualityProcessTracking", b =>
                {
                    ...
                    b.HasIndex("ProductionBatchId", "InspectionType", "IsDeliveryStatus")
                        .IsUnique()
                        .HasDatabaseName("UK_QPT_ProductionBatchTypeDelivery")
                        .HasFilter("[InspectionType] IS NOT NULL AND [IsDeliveryStatus] IS NOT NULL");
