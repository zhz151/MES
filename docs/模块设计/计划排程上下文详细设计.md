...
| **V5.7** | **2026-07-10** | **订单需求调整迁移至工单上下文**：OrderDemandAdjustment UI/API 从订单上下文迁移至工单上下文（工单需求调整页面），Controller/Blazor 移至工单模块，权限改为 WorkOrderRead/WorkOrderWrite；§2.1/§3.2/§4.1 更新为"已迁移至工单上下文"；实体命名空间改为 `MES.Data.Entities.WorkOrder` |
