...
const ENUM_MAP = {
  ...
  ManufacturingItem:       { OrderFinishedProduct: '订单成品', PreparedMaterial: '备料成品', SurplusStock: '余库料', SpecialDeliveryStatus: '特定交态成品' },
  MaterialCategory:        { RoundBar: '圆棒', RoughTube: '荒管', SemiProduct: '半成品', OrderFinished: '订单成品', PreparedFinished: '备料成品', CriticalFinished: '临界成品', DefectRoundBar: '次品圆棒', DefectRoughTube: '次品荒管', DefectSemiProduct: '次品半成品', DefectFinished: '次品成品', Scrap: '报废品', Surplus: '余库料', SpecialDeliveryFinished: '特定交态成品', DefectWIP: '次品在制' },
  ...
  BatchStatus:             { None: '未产', InProgress: '在产', Completed: '完成', Suspended: '挂起', Cancelled: '作废' },
  ...
  PipeCategory:            { TubeBlank: '荒管', WorkInProgress: '在制品', SurplusInventory: '余库料', CriticalFinished: '临界成品', OrderFinished: '订单成品', PreparedFinished: '备料成品', SpecialDelivery: '特定交态成品' },
