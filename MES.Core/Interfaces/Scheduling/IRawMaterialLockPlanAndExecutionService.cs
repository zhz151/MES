...
public interface IRawMaterialLockPlanAndExecutionService
{
    ...
    /// <summary>批量设置预执行标记（执行/预算投料日）</summary>
    ...
    Task<SetPreExecuteFlagsResult> SetPreExecuteFlagsAsync(List<int> workOrderIds, bool? isPreInput, DateTime? budgetInputDate = null);
