...
public interface IRawMaterialLockPlanAndExecutionService
{
    ...
    /// <summary>批量设置预执行标记（执行/预算投料日/主号齐全）</summary>
    ...
    Task<SetPreExecuteFlagsResult> SetPreExecuteFlagsAsync(List<int> workOrderIds, bool? isPreInput, bool? isMainNoMaterialComplete, DateTime? budgetInputDate = null);
}
