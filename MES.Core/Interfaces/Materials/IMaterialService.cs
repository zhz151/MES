...
public interface IMaterialService
{
    ...
    // ========== 打印 ==========
    Task<byte[]> PrintMaterialAsync(int id, List<PrintColumnDef>? columns = null);
    Task<byte[]> PrintMaterialBatchAsync(int[] ids, List<PrintColumnDef>? columns = null);
    Task<byte[]> PrintMaterialAllAsync(string? keyword, string? sortBy = null, bool isDescending = false, List<PrintColumnDef>? columns = null);
}
