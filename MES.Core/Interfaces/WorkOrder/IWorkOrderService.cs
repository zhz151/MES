...
public interface IWorkOrderService
{
    ...
    /// <summary>
    /// 根据订单号获取工单列表（返回精简 DTO，仅�?Id/工单号等基础字段�?    /// </summary>
    ...
    /// <summary>
    /// 删除工单（用�?订单已取�?工单待删�?区域�?    /// </summary>
    Task SoftDeleteAsync(int id);

    /// <summary>
    /// 检测单个订单变更并更新工单状�?    /// </summary>
    Task CheckAndUpdateWorkOrderStatusAsync(int salesOrderId);

    /// <summary>
    /// 检测所有已确认订单的变更并更新工单状�?    /// </summary>
    ...
    /// <summary>
    /// 全量刷新用料计划读模型（�?WorkOrders + 计划表重新计算）
    /// </summary>
    ...
    /// <summary>
    /// 获取工单筛选上下文（各列去重值），用�?ExcelFilter 下拉选项
    /// </summary>
