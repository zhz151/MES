...
public class StandardInspectionRequirementDto
{
...
public class CreateStandardInspectionRequirementRequest
{
...
public class UpdateStandardInspectionRequirementRequest
{
    [Required(ErrorMessage = "标准号不能为空")]
    [StringLength(100, ErrorMessage = "标准号长度不能超过100")]
    public string StandardNo { get; set; } = string.Empty;
