...
public class TensileTestController : ControllerBase
{
    ...
    [Authorize(Roles = Roles.Policies.QualityView)]
    public async Task<IActionResult> PrintBatchFile([FromBody] TensileTestPrintBatchRequest request)
    {
        ...
        return File(pdfBytes, "application/pdf", "室温拉伸检验-选中.pdf");
    }

    [HttpPost("print-all-file")]
    [Authorize(Roles = Roles.Policies.QualityView)]
    public async Task<IActionResult> PrintAllFile([FromBody] TensileTestPrintAllRequest request)
    {
        ...
        return File(pdfBytes, "application/pdf", "室温拉伸检验-全部.pdf");
    }
}
