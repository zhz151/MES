...
public class FactoryInspectionRequirementControllerTests : ControllerTestBase
{
    private readonly Mock<IFactoryInspectionRequirementService> _serviceMock;
    private readonly FactoryInspectionRequirementController _controller;

    public FactoryInspectionRequirementControllerTests()
    {
        _serviceMock = new Mock<IFactoryInspectionRequirementService>();
        _controller = new FactoryInspectionRequirementController(_serviceMock.Object);
    ...
    {
        var pagedResult = new PagedResult<FactoryInspectionRequirementDto>
        {
            Items = new List<FactoryInspectionRequirementDto> { new() { Id = 1, StandardNo = "GB/T 14976" } },
        ...
        var (_, response) = AssertOk<ApiResponse<PagedResult<FactoryInspectionRequirementDto>>>(result);
    ...
    public async Task GetPaged_LimitsPageSize()
    {
        _serviceMock.Setup(x => x.GetPagedAsync(It.IsAny<QueryParams>()))
            .ReturnsAsync(new PagedResult<FactoryInspectionRequirementDto> { Items = new List<FactoryInspectionRequirementDto>() });
    ...
    {
        var dto = new FactoryInspectionRequirementDto { Id = 1, StandardNo = "GB/T 14976" };
        _serviceMock.Setup(x => x.GetByIdAsync(1)).ReturnsAsync(dto);

        var result = await _controller.GetById(1);

        var (_, response) = AssertOk<ApiResponse<FactoryInspectionRequirementDto>>(result);
    ...
    {
        var request = new CreateFactoryInspectionRequirementRequest { StandardNo = "GB/T 8163" };
        var dto = new FactoryInspectionRequirementDto { Id = 1, StandardNo = "GB/T 8163" };
    ...
    {
        var request = new UpdateFactoryInspectionRequirementRequest { StandardNo = "GB/T 8163" };
        var dto = new FactoryInspectionRequirementDto { Id = 1, StandardNo = "GB/T 8163" };
