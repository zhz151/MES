...
public partial class FurnaceRegistrations
{
    ...
    private static List<ColumnDef> GetAllColumnDefs() => new()
    {
        ...
        new() { Key = "Weight",           Label = "重量",         SortKey = "weight" },
        new() { Key = "Carbon",           Label = "C",            SortKey = "carbon" },
        new() { Key = "Silicon",          Label = "Si",           SortKey = "silicon" },
        new() { Key = "Manganese",        Label = "Mn",           SortKey = "manganese" },
        new() { Key = "Phosphorus",       Label = "P",            SortKey = "phosphorus" },
        new() { Key = "Sulfur",           Label = "S",            SortKey = "sulfur" },
        new() { Key = "Nickel",           Label = "Ni",           SortKey = "nickel" },
        new() { Key = "Chromium",         Label = "Cr",           SortKey = "chromium" },
        new() { Key = "Molybdenum",       Label = "Mo",           SortKey = "molybdenum" },
        new() { Key = "Copper",           Label = "Cu",           SortKey = "copper" },
        new() { Key = "Nitrogen",         Label = "N",            SortKey = "nitrogen" },
        new() { Key = "Niobium",          Label = "Nb",           SortKey = "niobium" },
        new() { Key = "Titanium",         Label = "Ti",           SortKey = "titanium" },
        new() { Key = "Iron",             Label = "Fe",           SortKey = "iron" },
        new() { Key = "Aluminum",         Label = "Al",           SortKey = "aluminum" },
        new() { Key = "Tungsten",         Label = "W",            SortKey = "tungsten" },
        new() { Key = "PREN",             Label = "PREN腐蚀当量",  SortKey = "pren" },
