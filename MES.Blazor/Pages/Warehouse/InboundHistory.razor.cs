...
public partial class InboundHistory
{
    ...
    private static List<ColumnDef> GetAllColumnDefs() => new()
    {
        ...
        new() { Key = "InboundDate",         Label = "入库日期", SortKey = "InboundDate",    IsRequired = true },
        ...
        new() { Key = "MinLength",           Label = "最小长度", SortKey = "MinLength", FilterType = null },
        new() { Key = "MaxLength",           Label = "最大长度", SortKey = "MaxLength", FilterType = null },
        new() { Key = "InitialQuantity",     Label = "支数",     SortKey = "InitialQuantity", IsRequired = true, FilterType = null },
        new() { Key = "InitialWeight",       Label = "重量(kg)", SortKey = "InitialWeight",   IsRequired = true, FilterType = null },
        new() { Key = "UnitWeight",          Label = "单支重",   SortKey = "UnitWeight", FilterType = null },
        new() { Key = "Meters",              Label = "米数", SortKey = "Meters", FilterType = null },
        new() { Key = "Remark",              Label = "备注", SortKey = "Remark", FilterType = "string" },
        new() { Key = "IsLinkedToWorkOrder", Label = "关联工单", SortKey = "IsLinkedToWorkOrder", FilterType = "boolean",
        ...
        new() { Key = "ActualOuterDiameter", Label = "外径", SortKey = "ActualOuterDiameter", FilterType = null },
        new() { Key = "ActualWallThickness", Label = "壁厚", SortKey = "ActualWallThickness", FilterType = null },
