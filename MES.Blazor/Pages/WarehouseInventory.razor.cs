...
public partial class WarehouseInventory
{
    ...
    private static List<ColumnDef> GetAllColumnDefs() => new()
    {
        ...
        new() { Key = "InboundSource",       Label = "来源",     SortKey = "InboundSource", FilterType = "string" },
        ...
        new() { Key = "IsLinkedToWorkOrder", Label = "关联工单", SortKey = "IsLinkedToWorkOrder", FilterType = "boolean", BoolTrueLabel = "是", BoolFalseLabel = "否" },
