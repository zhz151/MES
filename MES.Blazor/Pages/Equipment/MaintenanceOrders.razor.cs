...
public partial class MaintenanceOrders
{
    private MudTable<MaintenanceOrderListDto>? table;
    private List<MaintenanceOrderListDto> _pageItems = new();
    ...
    private async Task<TableData<MaintenanceOrderListDto>> LoadDataFromServer(TableState state)
    {
        ...
        try
        {
            ...
            var result = await MaintenanceOrderService.GetPagedAsync(
            ...
            if (version != _loadVersion)
                return new TableData<MaintenanceOrderListDto> { Items = _pageItems, TotalItems = _totalCount };
        ...
        return new TableData<MaintenanceOrderListDto>
        {
            Items = _pageItems,
    ...
    private async Task LoadFilterContextsAsync()
    {
        try
        {
            var result = await MaintenanceOrderService.GetFilterContextsAsync();
            if (result.Success && result.Data != null)
            {
    ...
    protected override async Task OnInitializedAsync()
    {
        ...
        var savedState = await PageState.LoadAsync("maintenanceorders");
        if (savedState != null)
        {
    ...
    private async Task SavePageStateAsync()
    {
        ...
        await PageState.SaveAsync("maintenanceorders", state);
    }
}
