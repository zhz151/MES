...
public partial class Equipments
{
    ...
    private static List<ColumnDef> GetAllColumnDefs() => new()
    {
        ...
        new() { Key = "RunningStatus",     Label = "运行状态", SortKey = "runningstatus", FilterType = "enum",
            EnumOptions = new() { new("Normal", "正常"), new("Pending", "待维修"), new("InProgress", "维修中") } },
        new() { Key = "InspectionStatus",  Label = "点检状况", SortKey = "inspectionstatus", FilterType = "enum",
        ...
        new() { Key = "InspectionCycleDays",Label = "点检周期",  SortKey = "inspectioncycledays" },
        new() { Key = "CurrentInspectionStartDate",Label = "本次点检日起始", SortKey = "currentinspectionstartdate", FilterType = "date" },
        new() { Key = "MaintStatus",       Label = "保养状况", SortKey = "maintstatus", FilterType = "enum",
            EnumOptions = new() { new("Pending", "待执行"), new("Normal", "正常"), new("Overdue", "逾期"), new("NotApplicable", "不适用") } },
        ...
        new() { Key = "MaintCycleDays",    Label = "保养周期",   SortKey = "maintcycledays" },
