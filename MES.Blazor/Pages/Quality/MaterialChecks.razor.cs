...
public partial class MaterialChecks
{
    ...
    private static List<ColumnDef> GetAllColumnDefs() => new()
    {
        ...
        new() { Key = "TagNo",             Label = "挂牌号",     SortKey = "tagno", FilterType = "string", Visible = false },
        new() { Key = "WorkOrderNo",       Label = "工单号",     SortKey = "workorderno", FilterType = "string", Visible = false },
        new() { Key = "SalesOrderNo",      Label = "订单号",     SortKey = "salesorderno", FilterType = "string", Visible = false },
        new() { Key = "FurnaceNo",         Label = "炉号",       SortKey = "furnaceno", FilterType = "string", Visible = false },
        new() { Key = "SourceUnit",        Label = "来料单位",   SortKey = "sourceunit", FilterType = "string", Visible = false },
        new() { Key = "ProductionType",     Label = "生产类型",   SortKey = "productiontype", FilterType = "string", Visible = false },
        new() { Key = "ProductionCutQuantity", Label = "生产支数", SortKey = "productioncutquantity", FilterType = "number" },
        new() { Key = "Shift",             Label = "班次",        SortKey = "shift", FilterType = "string" },
        new() { Key = "Checker",           Label = "确认人",     SortKey = "checker", FilterType = "string" },
        new() { Key = "IsForceCompleted",  Label = "强制完成",   SortKey = "isforcecompleted", FilterType = "boolean", Visible = false, BoolTrueLabel = "是", BoolFalseLabel = "否" },
    ...
    private RenderFragment RenderCell(MaterialReceiveCheckDto item, ColumnDef col) => builder =>
    {
        ...
        switch (col.Key)
        {
            ...
            case "IsForceCompleted":
                ...
                {
                    await ProductionRecordService.UpdateMaterialReceiveCheckAsync(item.Id, new UpdateMaterialReceiveCheckRequest { IsForceCompleted = value });
