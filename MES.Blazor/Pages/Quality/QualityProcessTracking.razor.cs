...
public partial class QualityProcessTracking
{
    ...
    EnumOptions = DisplayHelper.GetEnumFilterOptions<ShiftType>() },
        ...
        var g3 = new List<ColumnDef>
        {
            ...
            new() { Key = "MaxInspectionDate",             Label = "最晚检验日期",  SortKey = "maxinspectiondate",       FilterType = "date",   Width = "120", GroupKey = 3, GroupName = "各项检验的日期" },
        };
    ...
    protected override async Task OnAfterRenderAsync(bool firstRender)
    {
        ...
        if (!_isArrowNavSetup)
        {
            ...
            if (!await JS.InvokeAsync<bool>("enableTableArrowNav", new object[] { "#quality-process-tracking-list-table" }))
