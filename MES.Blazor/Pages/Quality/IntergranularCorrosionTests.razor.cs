...
public partial class IntergranularCorrosionTests
{
    ...
    private async Task PrintSelected()
    {
        ...
        var apiUrl = $"{Http.BaseAddress}api/intergranular-corrosion-test/print-batch-file";
    ...
    {
        var apiUrl = $"{Http.BaseAddress}api/intergranular-corrosion-test/print-all-file";
