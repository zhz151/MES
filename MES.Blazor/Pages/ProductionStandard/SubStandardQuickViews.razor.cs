...
public partial class SubStandardQuickViews
{
    ...
    private static List<ColumnDef> GetAllColumnDefs() => new()
    {
        ...
        new() { Key = "ChemicalComposition",    Label = "化学成分",       SortKey = "chemicalcomposition",   FilterType = "string" },
        new() { Key = "HydrostaticTest",        Label = "液密检验",       SortKey = "hydrostatictest",       FilterType = "string" },
        ...
        new() { Key = "FerriteContent",         Label = "铁素体含量",     SortKey = "ferritecontent",        FilterType = "string" },
