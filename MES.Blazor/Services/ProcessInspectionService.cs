...
public class ProcessInspectionService
{
    ...
    public async Task<ApiResponse<PagedResult<ProcessInspectionDto>>> GetAllAsync(int pageIndex = 1, int pageSize = 20, string? keyword = null, string? sortBy = null, bool isDescending = true, DateTime? inspectionDateFrom = null, DateTime? inspectionDateTo = null)
    {
        try
        {
