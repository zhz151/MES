...
public class ProductionStandardService
{
    ...
    private const string BaseUrl = ApiEndpoints.Standard;
    ...
    /// <summary>打印单个产品标准</summary>
    public async Task<ApiResponse<string>> PrintStandardAsync(int id)
    {
        try
        {
    ...
    /// <summary>批量打印产品标准</summary>
    public async Task<ApiResponse<string>> PrintStandardBatchAsync(int[] ids)
    {
        try
        {
    ...
    /// <summary>按筛选条件打印全部产品标准</summary>
    public async Task<ApiResponse<string>> PrintStandardAllAsync(string? keyword = null, string? sortBy = null, bool isDescending = false)
    {
        try
        {
