...
builder.Services.AddScoped<ColdRollMachineGroupConfigService>();
...
builder.Services.AddScoped<MES.Blazor.Services.Payroll.PayrollDailyWageService>();
builder.Services.AddScoped<MES.Blazor.Services.Payroll.PayrollCollectiveService>();
builder.Services.AddScoped<MES.Blazor.Services.Payroll.PayrollAttendanceService>();
builder.Services.AddScoped<MES.Blazor.Services.Payroll.PayrollMiscWorkService>();
builder.Services.AddScoped<MES.Blazor.Services.Payroll.PayrollAllowanceService>();
builder.Services.AddScoped<MES.Blazor.Services.Payroll.PayrollMonthlySummaryService>();
