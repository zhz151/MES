// Global using directives for MES.Services
// DTO sub-namespaces
global using MES.Core.DTOs.Auth;
global using MES.Core.DTOs.Batch;
global using MES.Core.DTOs.Configuration;
global using MES.Core.DTOs.Equipment;
...
global using MES.Core.DTOs.Warehouse;
global using MES.Core.DTOs.WorkOrder;

// Interface sub-namespaces
global using MES.Core.Interfaces.Batch;
global using MES.Core.Interfaces.Configuration;
global using MES.Core.Interfaces.DataExchange;
global using MES.Core.Interfaces.Equipment;
