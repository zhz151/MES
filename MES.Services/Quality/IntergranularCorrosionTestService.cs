...
public class IntergranularCorrosionTestService : IIntergranularCorrosionTestService
{
    ...
    public IntergranularCorrosionTestService(AppDbContext context, ILogger<IntergranularCorrosionTestService> logger, IMemoryCache cache)
    {
        _context = context;
        _logger = logger;
        _cache = cache;
    ...
    {
        return await _cache.GetOrCreateAsync("IntergranularCorrosionTestService:FilterContexts", async entry =>
        {
    ...
    public async Task<byte[]> PrintBatchAsync(int[] ids, List<PrintColumnDef> columns)
    {
        ...
        return IntergranularCorrosionTestPrintHelper.GenerateBatchPdf(selected, columns);
    }
    ...
    public async Task<byte[]> PrintAllAsync(string? keyword, string? sortBy, bool isDescending, List<PrintColumnDef> columns, DateTime? inspectionDateFrom = null, DateTime? inspectionDateTo = null)
    {
        ...
        var result = await GetAllAsync(query);
        return IntergranularCorrosionTestPrintHelper.GenerateBatchPdf(result.Items, columns);
    }
    ...
    private static IntergranularCorrosionTestDto MapToDto(IntergranularCorrosionTest e) => new()
    {
        ...
        BendDegree = e.BendDegree,
        Magnification = e.Magnification,
        ObservationResult = e.ObservationResult,
        Judgment = e.Judgment,
    ...
    private static IntergranularCorrosionTest MapToEntity(CreateIntergranularCorrosionTestRequest r) => new()
    {
        ...
        BendDegree = r.BendDegree,
        Magnification = r.Magnification,
        ObservationResult = r.ObservationResult,
        Judgment = r.Judgment
    };
}
