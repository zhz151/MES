...
public class TensileTestService : ITensileTestService
{
    ...
    {
        return await _cache.GetOrCreateAsync(CacheKeys.TensileTestFilterContexts, async entry =>
        {
    ...
    public async Task<byte[]> PrintBatchAsync(int[] ids, List<PrintColumnDef> columns)
    {
        ...
        return TensileTestPrintHelper.GenerateBatchPdf(selected, columns);
    }
    ...
    private static TensileTestDto MapToDto(TensileTest e) => new()
    {
        ...
        OriginalGaugeLength = e.OriginalGaugeLength,
        FinalGaugeLength = e.FinalGaugeLength,
        TensileStrength = e.TensileStrength,
        YieldStrengthRp02 = e.YieldStrengthRp02,
        YieldStrengthRp1 = e.YieldStrengthRp1,
    ...
    private static TensileTest MapToEntity(CreateTensileTestRequest r) => new()
    {
        ...
        OriginalGaugeLength = r.OriginalGaugeLength,
        FinalGaugeLength = r.FinalGaugeLength,
        TensileStrength = r.TensileStrength,
        YieldStrengthRp02 = r.YieldStrengthRp02,
        YieldStrengthRp1 = r.YieldStrengthRp1,
