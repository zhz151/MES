...
public class HardnessTestService : IHardnessTestService
{
    ...
    {
        return await _cache.GetOrCreateAsync(CacheKeys.HardnessTestFilterContexts, async entry =>
        {
    ...
    public async Task<byte[]> PrintBatchAsync(int[] ids, List<PrintColumnDef> columns)
    {
        ...
        return HardnessTestPrintHelper.GenerateBatchPdf(selected, columns);
    }
    ...
    private static HardnessTestDto MapToDto(HardnessTest e) => new()
    {
        ...
        HardnessMode = e.HardnessMode,
        HardnessValue = e.HardnessValue,
        Judgment = e.Judgment,
    ...
    private static HardnessTest MapToEntity(CreateHardnessTestRequest r) => new()
    {
        ...
        HardnessMode = r.HardnessMode,
        HardnessValue = r.HardnessValue,
        Judgment = r.Judgment
    };
}
